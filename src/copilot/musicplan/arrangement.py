...
TECH_HOUSE_ARRANGEMENT: list[Section] = [
    ...
    Section("DROP", 32, ["Kick", "Clap", "Closed Hat", "Shaker", "Conga", "Clave", "Perc Loop", "Bass", "Vocal", "Stab", "FX", "Impact", "Downlifter", "Texture"]),
    Section("BREAK", 8, ["Shaker", "Conga", "Clave", "Vocal"]),
    Section("DROP2", 16, ["Kick", "Clap", "Closed Hat", "Shaker", "Conga", "Clave", "Perc Loop", "Bass", "Vocal", "Stab", "FX", "Impact", "Downlifter", "Texture"]),
