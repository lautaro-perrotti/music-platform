...
TECH_HOUSE_ARRANGEMENT: list[Section] = [
    ...
    Section("DROP", 32, ["Kick", "Clap", "Closed Hat", "Shaker", "Conga", "Clave", "Perc Loop", "Bass", "Vocal", "Stab", "Guitar", "FX", "Impact", "Downlifter", "Texture"]),
    Section("BREAK", 8, ["Shaker", "Conga", "Clave", "Vocal", "Sax"]),
    Section("DROP2", 16, ["Kick", "Clap", "Closed Hat", "Shaker", "Conga", "Clave", "Perc Loop", "Bass", "Vocal", "Stab", "Sax", "FX", "Impact", "Downlifter", "Texture"]),
