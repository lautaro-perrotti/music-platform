    ...
    *,
    ...
    for index, ref_window in enumerate(reference.windows):
        ...
        windows.append(MusicAnalysisWindow(
            ...
            section_label=str(low.get("section_label", ref_window.section_label)),
            ...
            kick_bass_overlap_ratio=low.get("kick_bass_overlap_ratio"),
            kick_bass_overlap_duration_s=low.get("kick_bass_overlap_duration_s"),
            lowend_measurement_status=str(low.get("lowend_measurement_status", "MASTER_ONLY")),
